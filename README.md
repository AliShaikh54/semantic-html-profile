...
This repository contains a clean and accessible personal profile web page built using
semantic HTML5 elements. The project focuses on proper document structure, accessibility,
and best practices in modern web development.
